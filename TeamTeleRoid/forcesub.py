    ...
    try:
        ...
        if user.status == "kicked":
            await bot.send_message(
                ...
                text="You Are Ban To Use Me. Contact My [Tamil Cine Hub](https://t.me/tamilcinehub).",
                parse_mode="markdown",
        ...
        await bot.send_message(
            chat_id=cmd.from_user.id,
            text="Somthing Went Wrong. Contact My [Support Group](https://t.me/Customer_Support_Group).",
            parse_mode="markdown",
            disable_web_page_preview=True
        )
        return 400
